...
Select * from TB_PEDIDO p cross join TB_USUARIO TU on p.CODIGO_CLIENTE = TU.CODIGO_USUARIO cross join tb_estado_pedido tep on p.CODIGO_ESTADO_PEDIDO = tep.CODIGO_ESTADO_PEDIDO;