...
CREATE TABLE TB_ACCESO (
    ...
    EMAIL_ACCESO VARCHAR(255) NOT NULL UNIQUE,
    CONTRASENA_ACCESO LONGTEXT NOT NULL,
    CODIGO_USUARIO INT NOT NULL,
    PRIMARY KEY (CODIGO_ACCESO),
    CONSTRAINT `TB_ACCESO_FK_TB_USUARIO` FOREIGN KEY (CODIGO_USUARIO) REFERENCES TB_USUARIO (CODIGO_USUARIO)
);
...
CREATE TABLE TB_SERVICIO (
	...
	RANGO_HORARIO DATETIME NOT NULL, /* EN FUNCIÓN A LA FECHA ELEGIDA, SACAMOS EL DÍA Y HACEMOS SELECT DE HORAS EN ESE DÍA*/
...
CREATE TABLE TB_DETALLE_CITA_HISTORIAL_CLINICO (
    ...
    CONSTRAINT `TB_DETALLE_CITA_HISTORIA_CLINICO_FK_TB_HISTORIAL_CLINICO` FOREIGN KEY (CODIGO_HISTORIAL_CLINICO) REFERENCES TB_CITA (CODIGO_HISTORIAL_CLINICO)
);
...
CREATE TABLE TB_PEDIDO (
    ...
    CODIGO_EMPLEADO INT NOT NULL, /* TB_USUARIO*/
    PRIMARY KEY (CODIGO_PEDIDO),
    CONSTRAINT `TB_PEDIDO_FK_TB_USUARIO_CLIENTE` FOREIGN KEY (CODIGO_CLIENTE) REFERENCES TB_USUARIO (CODIGO_USUARIO),
    CONSTRAINT `TB_PEDIDO_FK_TB_USUARIO_EMPLEADO` FOREIGN KEY (CODIGO_EMPLEADO) REFERENCES TB_USUARIO (CODIGO_USUARIO)
);
...
CREATE TABLE TB_BOLETA (
    ...
    CONSTRAINT `TB_BOLETA_FK_TB_USUARIO_CLIENTE` FOREIGN KEY (CODIGO_CLIENTE) REFERENCES TB_USUARIO (CODIGO_CLIENTE),
