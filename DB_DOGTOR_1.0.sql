...
CREATE TABLE TB_DETALLE_HISTORIAL_CLINICO_VACUNA (
    ...
    CONSTRAINT `TB_DETALLE_HISTORIAL_CLINICO_FK_TB_HISTORIAL_CLINICO` FOREIGN KEY (CODIGO_HISTORIAL_CLINICO) REFERENCES TB_HISTORIAL_CLINICO (CODIGO_HISTORIAL_CLINICO),
    CONSTRAINT `TB_DETALLE_HISTORIAL_CLINICO_FK_TB_VACUNA` FOREIGN KEY (CODIGO_VACUNA) REFERENCES TB_VACUNA (CODIGO_VACUNA)
);
