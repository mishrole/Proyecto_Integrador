...
public interface CarritoRepository extends JpaRepository<Carrito, Integer> {
	...
	@Query("Select sum(c.producto.precio_producto * c.cantidad_carrito) from Carrito c, Usuario u, Producto p where c.usuario.codigo_usuario = u.codigo_usuario and c.producto.codigo_producto = p.codigo_producto and c.codigo_usuario like :param_usuario")
	public abstract Double subtotalCarrito(@Param("param_usuario") Integer codigo_usuario);
}
