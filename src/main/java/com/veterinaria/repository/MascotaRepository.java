...
public interface MascotaRepository extends JpaRepository<Mascota, Integer>{
	...
	@Query("Select m from Mascota m, Visibilidad v where m.codigo_visibilidad = v.codigo_visibilidad and m.codigo_visibilidad = 1 and m.nombre_mascota like :param_mascota")
