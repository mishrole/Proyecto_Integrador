...
<body class="background__light__gray">
	...
	<script type="text/javascript">
		...
		function generarCuerpoPedidos(pedido) {
			...
			const deliveryMan = document.createElement('p');
			deliveryMan.className = "m-0";
			deliveryMan.innerHTML = "Repartidor: " + pedido.usuarioRepartidor.nombre_usuario + " " + pedido.usuarioRepartidor.apellido_usuario;
			...
			divBodyContainer.append(divBodyHeader, deliveryMan, divDetalleContainer);
